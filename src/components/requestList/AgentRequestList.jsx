...
function AgentRequestList() {
    ...
    const data = [
        `${VITE_API_URL}/api/RequestRent/agent/${user.idUser}`,
        `${VITE_API_URL}/api/RequestSale/agent/${user.idUser}`,
    ];
    ...
    const acceptRequest = async (id, typeDemande) => {
        try {
            await axios.put(`${VITE_API_URL}/api/Request${typeDemande}/accept/${id}`)
    ...
    const declineRequest = async (id, typeDemande) => {
        try {
            await axios.put(`${VITE_API_URL}/api/Request${typeDemande}/refuse/${id}`)
    ...
    const updateOwner = async (id, typeDemande, idUser) => {
        try {
            ...
            await axios.put(`${VITE_API_URL}/api/Request${typeDemande}/updatePerson/${id}/${idUser}`)
